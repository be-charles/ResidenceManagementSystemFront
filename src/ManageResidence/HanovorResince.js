...
class HanovorResince extends React.Component {
    ...
    DeleteRoom(roomNumber) {
        CatsvillResService.deleteroom(roomNumber).then(res => {
    ...
    componentDidMount() {
        ...
        CatsvillResService.getResUser().then((response) => {
    ...
    render() {
        ...
        return (
            ...
            <>
                <h1 className="text-center">Hanovor Room Management</h1>
